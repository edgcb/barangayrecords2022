...
?>
    ...
    <head>
        ...
        <title>Profile - Barangay Records Management</title>
                                ...
                                <div class="card shadow mb-4 m-auto" style="height: 35rem;">
                                    ...
                                    <div class="card-body">
                                        <div class="chart-area">
                                            <form action="updateprofile.php?updatedb=<?php echo $id ?>" method="POST" class="user">
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-user" value="<?php echo $row['name'] ?>" name="name" id="name" placeholder="First Name">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control form-control-user" value="<?php echo $_SESSION['Contact'] ?>" name="contact" id="contact" placeholder="Email Address">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <input type="email" class="form-control form-control-user" value="<?php echo $_SESSION['Email'] ?>" name="email" id="email" placeholder="Email Address">
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        <div class="col-sm-6 ml-4">
                                                            ...
                                                            <div class="col-sm-3 ml-5">
                                                                <input type="radio" class="form-check-input" <?php if ($_SESSION['Sex'] == "Male") echo "checked"; ?> value="Male" name="sex" id="sex" autocomplete="on" />
                                                                <label class="form-check-label" for="sex">Male</label>
                                                                <div class="ml-0">
                                                                    <input type="radio" class="form-check-input" <?php if ($_SESSION['Sex'] == "Female") echo "checked"; ?> value="Female" name="sex" id="sex" autocomplete="on" />
                                                    ...
                                                    <div class="col ml-0 mt-2">
                                                        <input type="date" class="form-control form-control-user" name="birthdate" id="birthdate" value="<?php echo $_SESSION['Birthdate'] ?>" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user" value="<?php echo $_SESSION['Address'] ?>" name="address" id="address" placeholder="Address">
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-center align-items-center mt-5">
                                                    <button class="btn btn-primary btn-user justify-content-center" name="updatedb" style="width: 180px;" value="Submit"> Update </button>
                                                    
                                                
                                                <div class="ml-3 center">
                                                    <a class="btn btn-danger btn-user" style="width: 180px;" href="index.php" role="button">Cancel</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
