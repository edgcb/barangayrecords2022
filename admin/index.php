                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Sample 3
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
...
<!-- <head>
    ...
    <title>
        Admin - Barangay Records Management
    </title>
</head>
...
<!-- <div class="col">
    <br>
    <p class="fs-3 mb-0"> <?php echo "Welcome, " . $_SESSION['Name']; ?>
        <br>
    <div class="fs-6 mt-1">
        Administrator
    </div>
...
<div class="col col-lg-2 mt-3">
    ...
    <!-- <a href="edit_data.php?fetchID="> -->
    <!-- <a class="text-end btn btn-outline-dark" href="editaccount.php?getID=<?php echo $_SESSION['id'] ?>" role="button"> Edit Account </a> -->
    <!-- <button class="" name="editaccount" class="pt-3" id="editaccount" type="submit"> Edit account </button> -->
<!-- </div>
</div> -->
...
<!-- <div class="container text-center">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="useraccounts.php" class="btn btn-squared-default-plain btn-primary ">
                    <br>
                    <h6 class="text-start"> User accounts </h6>
                </a>
                <a href="../logout.php" class="btn btn-squared-default-plain btn-danger">
                    <br>
                    <br>
