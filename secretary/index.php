...
<head>
    ...
    <title>Secretary - Barangay Records Management</title>
...
<head>
    <link rel="stylesheet" a href="../bootstrap-5.1.1-dist/css/bootstrap.css" />
    <title>
        Secretary - Barangay Records Management
    </title>
</head>
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="barangaycertificates.php" class="btn btn-squared-default-plain btn-primary">
                    <br>
                    <h6 class="text-start"> Barangay Certificates </h6>
                </a>
