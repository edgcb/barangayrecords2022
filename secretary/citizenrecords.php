...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from citizen_records WHERE first_name like '%$searchphrase%' OR middle_name like '%$searchphrase%' OR last_name like '%$searchphrase%'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Citizen Records</h1>
                        <a href="addcitizen.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-users fa-sm text-white-50"></i> Add Citizen</a>
                    </div>
                                                ...
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Zone Number of the Citizen" style="width: 60px;">Zone</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Address of the Citizen" style="width: 65px;">Address</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Contact of the Citizen" style="width: 70px;">Contact</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Gender of the Citizen" style="width: 30px;">Gender</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr> 
                                                            <td><?php echo $row["last_name"], $comma, $space, $row["first_name"], $space, $row["middle_name"];  ?> </td>
                                                            <td><?php echo $row["zone"];  ?></td>
                                                            <td><?php echo $row["address"];  ?></td>
                                                            <td><?php echo $row["contact"]; ?></td>
                                                            <td><?php echo $row["sex"];  ?></td>
                                                            <td> <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="editcitizen.php?fetchID=<?php echo $id ?>" role="button"> <i class="fas fa-edit"></i> Edit</a>  </td>
                                                            </tr>
                                                        <?php
                                                        }
                                                        ?>
...
<!-- <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mdb-ui-kit/3.6.0/mdb.min.js"></script>
    <title>
        Citizen Records - Barangay Records Management
    </title>
</head>
...
<?php
                                                    if (isset($_GET['successful'])) {
                                                        ...
                                                        $Message = "Citizen have been successfully added";
?>
...
<?php
                                                    ...
                                                    if (isset($_GET['citizenupdated'])) {
                                                        $Message = $_GET['citizenupdated'];
                                                        $Message = "Citizen's information has been updated";
?>
    <div class="alert alert-success text-center">
        <?php echo $Message ?>
    </div>
...
<!-- <div class="col-md-12">
    <div class="row justify-content-md-center">
        ...
        <div class="col justify-content-lg-end mb-4">
            ...
            <a class="btn btn-success" href="addcitizen.php" type="button">Add Citizen</a>
        </div>
    </div>
            ...
            <thead class="thead-primary">
                ...
                <tr>
                    ...
                    <th>Actions</th>
                        ...
                        <td>
                            <div class="span2">
                                <a class="btn btn-primary text-light" href="editcitizen.php?fetchID=<?php echo $id ?>" role="button"> <i class="fas fa-edit"></i> Edit</a>
                                ...
                                <script>
                                    function deleteconfirm() {
                                        // var result;
                                        var del = confirm("Are you sure you want to DELETE this CITIZEN on the record? This action cannot be UNDONE!");
                                        if (del == true) {
                                            window.location = "deletecitizen.php?deletecitizen=<?php echo $id ?>"
                                        } else {
                                            return false;
