...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from cert_receipt WHERE payor like '%$searchphrase%' OR nature_of_collection like '%$searchphrase%' OR agency like '%$searchphrase%' OR fund like '%$searchphrase%' OR account_code like '%$searchphrase%' OR payment_method like '%$searchphrase%' OR total_amount like '%$searchphrase%' OR drawee_bank like '%$searchphrase%' OR number_drawee like '%$searchphrase%' OR drawee_date like '%$searchphrase%' OR date_issued like '%$searchphrase%'";
