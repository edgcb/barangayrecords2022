...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from cedula_records WHERE name like '%$searchphrase%' OR tin like '%$searchphrase%' OR address like '%$searchphrase%' OR icr_no like '%$searchphrase%' OR occupation like '%$searchphrase%' OR date like '%$searchphrase%'";
