...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from certresidency_records WHERE name like '%$searchphrase%' OR address like '%$searchphrase%' OR years_of_residency like '%$searchphrase%' OR purpose like '%$searchphrase%' OR date like '%$searchphrase%'";
