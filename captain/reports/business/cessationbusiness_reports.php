...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from cessationbusiness_records WHERE name like '%$searchphrase%'";
...
$query1 = "select (SELECT Count(*) FROM cessationbusiness_records) as cessationbusiness";
...
<head>
    ...
    <title>Cessation of Business Records - Barangay Records Management</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="#" class="dropdown-toggle" data-toggle="collapse" role="button" aria-haspopup="true" data-target="#collapseBusiness" aria-expanded="true" aria-controls="collapseBusiness">Business</a>

                        <ul class="submenu dropdown-menu" id="collapseBusiness">
                            <a class="dropdown-item" href="businessclearance_reports.php">Business<br>Clearance</a>
                            <a class="dropdown-item active" href="cessationbusiness_reports.php">Cessation<br>of Business</a>


                        </ul>

                        <a class="collapse-item" href="../payments/taxreceipt_reports.php">Tax Payments</a>
                        <a class="collapse-item" href="../payments/certreceipt_reports.php">Brgy.<br>Certificates Payment</a>
                    </div>
                </div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cessation of Business Records</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Cessation of Business Records</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                while ($row = mysqli_fetch_assoc($result1)) {
                                                    $cessationbusiness = $row['cessationbusiness'];
                                                    echo $cessationbusiness;
                                                ?>
                        ...
                        <div class="col-xl-12 col-lg-6 m-auto">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Cessation of Business Records</h6>
                                    <style>
                                        #dataTable_filter {
                                            float: right;
                                        }
                                        ...
                                        <div class="row-xl-11">
                                            <div class="col-sm-12 m-auto">
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name of Business" style="width: 140px;">Business Name</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Address of Business" style="width: 100px;">Address</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Owner's Name" style="width: 40px;">Owner</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Owner's Address" style="width: 30px;">Owner's Address</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Date of Cessation" style="width: 30px;">Date of Cessation</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Purpose of getting Cessation of Business certificate" style="width: 30px;">Purpose</th>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th rowspan="1" colspan="1">Owner's Address</th>
                                                            <th rowspan="1" colspan="1">Date of Cessation</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $Owneraddress; ?></td>
                                                                <td><?php echo $Dateofcessation;  ?></td>
