...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from busclearance_records WHERE name like '%$searchphrase%'";
...
$query1 = "select (SELECT Count(*) FROM busclearance_records) as busclearance";
...
<head>
    ...
    <title>Business Clearance Records - Barangay Records Management</title>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <ul class="submenu dropdown-menu" id="collapseBusiness">
                            <a class="dropdown-item active" href="businessclearance_reports.php">Business<br>Clearance</a>
                            <a class="dropdown-item" href="cessationbusiness_reports.php">Cessation<br>of Business</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Business Clearance Records</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Business Clearance Records</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                while ($row = mysqli_fetch_assoc($result1)) {
                                                    $busclearance = $row['busclearance'];
                                                    echo $busclearance;
                                                ?>
                                        ...
                                        <div class="row-xl-11">
                                            <div class="col-sm-12 m-auto">
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name of Business" style="width: 90px;">Business Name</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Address of Business" style="width: 65px;">Address</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Type of Business" style="width: 70px;">Type of Business</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Owner's Business" style="width: 40px;">Owner</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Residence Address" style="width: 30px;">Residence Address</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Applied For" style="width: 30px;">Applied For</th>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th rowspan="1" colspan="1">Type of Business</th>
                                                            <th rowspan="1" colspan="1">Owner</th>
                                                            <th rowspan="1" colspan="1">Residence Address</th>
                                                            <th rowspan="1" colspan="1">Applied For</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $Typeofbusiness;  ?></td>
                                                                <td><?php echo $Owner; ?></td>
                                                                <td><?php echo $Residenceaddress;  ?></td>
                                                                <td> <?php echo $Appliedfor; ?></td>
                                                                <td> <?php echo $Date; ?></td>
                                                            </tr>
