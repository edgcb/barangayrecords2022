...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from goodmoral_records WHERE name like '%$searchphrase%'";
...
$query1 = "select (SELECT Count(*) FROM goodmoral_records) as goodmoral";
...
<head>
    ...
    <title>Certificate of Good Moral Records - Barangay Records Management</title>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <ul class="submenu dropdown-menu" id="collapseIndividual">
                            ...
                            <a class="dropdown-item active" href="certificateofgoodmoral_reports.php">Certificate of<br>Good Moral</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Certificate of Good Moral Records</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Certificate of Good Moral Records</div>
                        ...
                        <div class="col-xl-12 col-lg-6 m-auto">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Certificate of Good Moral Records</h6>
                                    <style>
                                        #dataTable_filter {
                                            float: right;
                                        }
                                                ...
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Purpose of getting Certificate of Good Moral" style="width: 30px;">Purpose</th>
