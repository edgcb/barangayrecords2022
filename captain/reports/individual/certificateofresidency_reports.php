...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from certresidency_records WHERE name like '%$searchphrase%'";
    $result = mysqli_query($conn, $query);
} else {
    $query = "SELECT * from certresidency_records";
    $result = mysqli_query($conn, $query);
    $searchphrase = "";
}
...
$query1 = "select (SELECT Count(*) FROM certresidency_records) as certresidency";
...
<head>
    ...
    <title>Certificate of Residency Records - Barangay Records Management</title>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <ul class="submenu dropdown-menu" id="collapseIndividual">
                            ...
                            <a class="dropdown-item active" href="certificateofresidency_reports.php">Certificate of<br>Residency</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Certificate of Residency Records</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Certificate of Residency Records</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                while ($row = mysqli_fetch_assoc($result1)) {
                                                    $certresidency = $row['certresidency'];
                                                    echo $certresidency;
                                                ?>
                        ...
                        <div class="col-xl-12 col-lg-6 m-auto">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Certificate of Residency Records</h6>
                                    <style>
                                        #dataTable_filter {
                                            float: right;
                                        }
                                                ...
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Purpose of getting Certificate of Residency" style="width: 40px;">Years of Residency</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Purpose of getting Certificate of Residency" style="width: 30px;">Purpose</th>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th rowspan="1" colspan="1">Years of Residency</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            $Address = $row['address'];
                                                            $Yearsresidency = $row['years_of_residency'];
                                                            $Purpose = $row['purpose'];
                                                            $Date = $row['date'];
                                                            $space = " ";
                                                            $comma = ",";
...
<!-- 
    <title>
        Certificate of Residency Records - Barangay Records Management
    </title>
</head>
        ...
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <br>
                    <h2 class="heading-section mt-3">Certificate of Residency Records</h2>
