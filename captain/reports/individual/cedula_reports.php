...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from cedula_records WHERE name like '%$searchphrase%'";
    $result = mysqli_query($conn, $query);
} else {
    $query = "SELECT * from cedula_records";
    $result = mysqli_query($conn, $query);
    $searchphrase = "";
}


$query1 = "select (SELECT Count(*) FROM cedula_records) as cedula";
...
<head>
    ...
    <title>Cedula Records - Barangay Records Management</title>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <ul class="submenu dropdown-menu" id="collapseIndividual">
                            ...
                            <a class="dropdown-item" href="indigencycertificate_reports.php">Indigency<br>Certificate</a>
                            ...
                            <a class="dropdown-item active" href="cedula_reports.php">Cedula</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cedula Records</h1>
                        ...
                        <div class="col-xl-12 col-lg-6 m-auto">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Cedula Records</h6>
                                    <style>
                                        #dataTable_filter {
                                            float: right;
                                        }
                                                ...
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Gender of the Citizen" style="width: 65px;">Gender</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Civil Status of the Citizen" style="width: 70px;">Civil Status</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="TIN Number of the citizen" style="width: 40px;">TIN</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Address of the Citizen" style="width: 30px;">Address</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Citizenship of the Citizen" style="width: 30px;">Citizenship</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="ICR number of Citizen (If applicable)" style="width: 30px;">ICR No. (if an Alien)</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Occupation of the Citizen" style="width: 20px;">Occupation</th>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th rowspan="1" colspan="1">ICR No. (if an Alien)</th>
...
<!-- <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mdb-ui-kit/3.6.0/mdb.min.js"></script>
        ...
        <title>
            Cedula Records - Barangay Records Management
        </title>
    </head>
            ...
            <div class="container mb-5">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-5">
                        <br>
                        <h2 class="heading-section mt-3"> Cedula Records</h2>
                    ...
                    <div class="col-md-12">
                        <div class="row justify-content-md-center">
                            ...
                            <div class="col justify-content-lg-end mb-3">
                                <a class="btn btn-danger me-md-2" href="individual_reports_2.php" type="button">Back</a>
                            </div>
                        </div>
