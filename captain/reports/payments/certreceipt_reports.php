...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from cert_receipt WHERE payor like '%$searchphrase%' OR nature_of_collection like '%$searchphrase%' ";
    $result = mysqli_query($conn, $query);
} else {
    $query = "SELECT * from cert_receipt";
    $result = mysqli_query($conn, $query);
    $searchphrase = "";
}
...
$query1 = "select (SELECT Count(*) FROM cert_receipt) as certreceipt";
...
<head>
    ...
    <title>Barangay Certificates Payment Records - Barangay Records Management</title>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <ul class="submenu dropdown-menu" id="collapseIndividual">
                            <a class="dropdown-item" href="../individual/barangaycertification_reports.php">Barangay<br>Certification</a>
                            <a class="dropdown-item" href="../individual/barangayclearance_reports.php">Barangay<br>Clearance</a>
                            <a class="dropdown-item" href="../individual/indigencycertificate_reports.php">Indigency<br>Certificate</a>
                            <a class="dropdown-item" href="../individual/certificateofresidency_reports.php">Certificate of<br>Residency</a>
                            <a class="dropdown-item" href="../individual/healthcertificate_reports.php">Health Certificate</a>
                            <a class="dropdown-item" href="../individual/certificateofgoodmoral_reports.php">Certificate of<br>Good Moral</a>
                            <a class="dropdown-item" href="../individual/cedula_reports.php">Cedula</a>
                        ...
                        <a class="collapse-item" href="taxreceipt_reports.php">Tax Payments</a>
                        <a class="collapse-item active" href="certreceipt_reports.php">Brgy.<br>Certificates Payment</a>
                    </div>
                </div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Barangay Certificates Payment Records</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Barangay Certificates Payment Records</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                while ($row = mysqli_fetch_assoc($result1)) {
                                                    $certreceipt = $row['certreceipt'];
                                                    echo $certreceipt;
                                                ?>
                        ...
                        <div class="col-xl-12 col-lg-6 m-auto">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Barangay Certificates Payment Records</h6>
                                    <style>
                                        #dataTable_filter {
                                            float: right;
                                        }
                                        ...
                                        <div class="row-xl-11">
                                            <div class="col-sm-12 m-auto">
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Payor" style="width: 140px;">Payor</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Agency" style="width: 100px;">Agency</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Nature of Collection" style="width: 40px;">Nature of Collection</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Payment Method" style="width: 30px;">Payment Method</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Total Amount" style="width: 30px;">Total Amount</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Drawee Bank" style="width: 30px;">Drawee Bank (for Money Order)</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Drawee Number" style="width: 30px;">Drawee Number</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Drawee Date" style="width: 30px;">Drawee Date</th>
                                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Date Issued" style="width: 30px;">Date Issued</th>
                                                        </tr>
                                                    </thead>
                                                    <tfoot>
                                                        <tr>
                                                            <th rowspan="1" colspan="1">Payor</th>
                                                            <th rowspan="1" colspan="1">Agency</th>
                                                            <th rowspan="1" colspan="1">Nature of Collection</th>
                                                            <th rowspan="1" colspan="1">Payment Method</th>
                                                            <th rowspan="1" colspan="1">Total Amount</th>
                                                            <th rowspan="1" colspan="1">Drawee Bank (for Money Order)</th>
                                                            <th rowspan="1" colspan="1">Drawee Number</th>
                                                            <th rowspan="1" colspan="1">Drawee Date</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                <td><?php echo $Payor;  ?> </td>
                                                                <td><?php echo $Agency;  ?></td>
                                                                <td><?php echo $Natureofcollection;  ?></td>
                                                                <td><?php echo $Paymentmethod; ?></td>
                                                                <td><?php echo $Totalamount;  ?></td>
                                                                <td> <?php echo $Draweebank; ?></td>
                                                                <td> <?php echo $Draweenumber; ?></td>
                                                                <td> <?php echo $Draweedate; ?></td>
                                                                <td> <?php echo $Date; ?></td>
                                                            </tr>
...
<head>
    ...
    <!-- <title>
        Brgy. Certificate Payment Records - Barangay Records Management
    </title>
</head>
        ...
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <br>
                    <h2 class="heading-section mt-3"> Brgy. Certificate Payment Records</h2>
