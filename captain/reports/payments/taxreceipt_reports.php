...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * from tax_receipt WHERE payor like '%$searchphrase%' OR nature_of_collection like '%$searchphrase%'";
...
$query1 = "select (SELECT Count(*) FROM tax_receipt) as taxreceipt";
...
<head>
    ...
    <title>Tax Receipt Payment Records - Barangay Records Management</title>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <ul class="submenu dropdown-menu" id="collapseBusiness">
                            <a class="dropdown-item" href="../business/">Business<br>Clearance</a>
                            <a class="dropdown-item active" href="../business/cessationbusiness_reports.php">Cessation<br>of Business</a>


                        </ul>

                        <a class="collapse-item active" href="taxreceipt_reports.php">Tax Payments</a>
                        <a class="collapse-item" href="certreceipt_reports.php">Brgy.<br>Certificates Payment</a>
                    </div>
                </div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tax Receipt Payment Records</h1>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Tax Receipt Payment Records</div>
                        ...
                        <div class="col-xl-12 col-lg-6 m-auto">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tax Receipt Payment Records</h6>
                                    <style>
                                        #dataTable_filter {
                                            float: right;
                                        }
