...
<head>
    ...
    <title>Treasurer - Barangay Records Management</title>
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="barangaypayments.php" class="btn btn-squared-default-plain btn-primary">
                    <br>
                    <h6 class="text-start"> Barangay Payments & Fees </h6>
                </a>
                <a href="financialrecords.php" class="btn btn-squared-default-plain btn-primary">
                    <br>
                    <h6 class="text-start"> Financial Records </h6>
                </a>
                </p>
            </div>
        </div>
